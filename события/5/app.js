// Необходимо отобразить инпут числовой и кнопку. После нажатия на кнопку необходимо
//  получить значение из инпута. Проверить, что это число > 0. Если проверка true, то вывести в Результат ряд Фибоначчи
